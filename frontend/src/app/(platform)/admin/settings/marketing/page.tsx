// src/app/(platform)/admin/settings/marketing/page.tsx
//
// Platform superadmin: marketing landing page content management.
//
// Displays all marketing sections as collapsible cards with inline editing.
// All requests go through `adminClient` (via `admin-marketing` helpers) --
...
const SECTION_ORDER: MarketingSectionKey[] = [
  'hero',
  'problem_solution',
  'how_it_works',
  'cta_mid',
...
const SECTION_FIELDS: Record<MarketingSectionKey, SectionFieldConfig> = {
  hero: {
    fields: [
...
// ──────────────────────────────────────────────────────────────────────
// Input styles (match existing admin pages)
// ──────────────────────────────────────────────────────────────────────
...
export default function AdminMarketingPage() {
  ...
  useEffect(() => {
    document.title = 'Marketing — NERBIS Admin';
  }, []);
      ...
      <main className="fade-up-auth mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Ruta" className="mb-4">
          <ol className="flex items-center gap-1.5 text-xs text-slate-500">
            ...
            <li className="font-medium text-slate-700">Marketing</li>
          </ol>
        </nav>
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Configura el contenido de cada seccion del sitio web de NERBIS.
          </p>
        </div>
