        ...
        <div className="space-y-3">
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full mt-1.5 px-3 py-2.5 rounded-lg border border-gray-200 text-[0.88rem] text-gray-700 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 resize-none transition-colors"
            />
          </div>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {onNavigateToSection && (
            <button
              ...
              className="flex items-center gap-1 text-[0.72rem] text-foreground font-medium hover:underline cursor-pointer"
            >
              Editar
