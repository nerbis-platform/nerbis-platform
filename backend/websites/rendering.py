"""Standalone HTML rendering engine for tenant websites."""
...
class SiteRenderer:
    """Renders a complete HTML page from website config data."""
    ...
    def __init__(
        ...
        *,
        ...
        page_slugs: dict | None = None,
        tenant_name: str = "",
        tenant_slug: str = "",
        tenant_logo: str = "",
        tenant_modules: dict | None = None,
        base_url: str = "",
        ...
        self._page_slugs = page_slugs or {}
        ...
        self._badge_logo_url = badge_logo_url
        self._media = media or {}
        self._industry = industry
        self._tenant_info = tenant_info or {}

    @staticmethod
    def resolve_page(pages_data, content_data, seo_data, structure, page_id="home"):
        """Resolve which page to render, returns (active_sections, content, seo, page_slugs)."""
        seo = dict(seo_data or {})
        page_slugs = {}
        if pages_data.get("pages"):
            ...
            page_obj = next(
                (p for p in all_pages if p["id"] == page_id),
                all_pages[0] if all_pages else {},
            )
        ...
        return active_sections, content, seo, page_slugs

    def render(self):
        """Generate full HTML for the website."""
        theme = self._theme
        ...
        tenant_info = self._tenant_info
        show_badge = self._show_badge
        badge_logo_url = self._badge_logo_url
